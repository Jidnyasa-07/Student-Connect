...
<footer id="myFooter" class="mt-5">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h2 class="logo"><a href="index.php"><img class="imgLogo" src='img/flogo2.jpg'></a></h2>
                </div>
                <div class="col-sm-2">
                    <h5>Get started</h5>
                    <ul>
                        ...
                        <li><a href="forum.php">The StudConn Forum</a></li>
                        <li><!--<a href="hub.php">-->The StudConn Hub</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>About us</h5>
                ...
                <div class="col-sm-3">
                    <div class="social-networks">
                        <!--<a href="https://github.com/msaad1999/KLiK--PHP-coded-Social-Media-Website" -->
                           class="contact"><i class="fa fa-github fa-2x"></i></a>
                    </div>
